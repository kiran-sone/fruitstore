                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-end">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Manage Order Details</li>
                            </ol>
                        </div>
                    </div>
                    <!--end::Row-->
                        ...
                        <div class="col-12 col-sm-12 col-md-12">
                            ...
                            <div class="col-md-7 col-lg-7 col-12 col-sm-12">
                                <table class="table table-bordered" id="ordersTable" role="table">
                                    ...
                                    <tbody>
                                        @foreach($order_items as $okey => $item)
                                            @php
                                            ...
                                            <tr class="align-middle">
                                                <td>{{ $okey+1 }}</td>
                                                <td>
                                                    <img src="{{ url('assets/uploads/'.$fruit['image']) }}" style="width:100px">
                                                </td>
                                                <td><a href="{{ url('/cms/editfruit/' . $fruit['fruit_id']) }}" target="_blank">{{ $fruit['name'] }}</a></td>
                                                <td>INR {{ intval($item['unit_price']) }}</td>
                                                <td>{{ $item['qty'] }}</td>
                                                <td>INR {{ $item['unit_price'] * $item['qty'] }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                            ...
                            <div class="col-md-5 col-lg-5 col-12 col-sm-12">
                                    ...
                                    <div class="cart-buttons">
                                        <a href="{{ url('/cms/orders') }}" class="btn btn-sm btn-primary">Go To Orders</a>
                                    </div>
                                    @endif
                            </div>
                            @else
