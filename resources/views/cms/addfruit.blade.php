...
<head>
    ...
    <title>Add Fruit | Fruit Store</title>
    ...
    <div class="app-wrapper">
        ...
        <main class="app-main">
            ...
            <div class="app-content">
                <!--begin::Container-->
                <div class="container-fluid">
                    <form class="needs-validation" action="{{ url('cms/addfruit') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Body-->
                        <div class="card-body">
                            <!--begin::Row-->
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="fruitName" name="fruitName" value="" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="fQuantity" name="fQuantity">
                                    <div class="invalid-feedback"></div>
                                </div>
                                <!--end::Col-->
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="any" class="form-control" id="fPrice" name="fPrice" required>
                                    <div class="invalid-feedback"></div>
                                </div>
                                <!--end::Col-->
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea type="text" class="form-control" id="fDescr" name="fDescr" rows=4></textarea>
                                    <div class="invalid-feedback"></div>
                                </div>
                                <!--end::Col-->
